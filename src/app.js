...
app.get('/api/health', (req, res) => {
  res.json({ success: true, message: 'Manga Management System Backend is running' });
});
...
app.patch('/api/users/:userId/notifications/read-all', require('./middlewares/auth.middleware').authenticateToken, (req, res, next) => {
  require('./modules/notifications/notifications.controller').markAllRead(req, res, next);
});
