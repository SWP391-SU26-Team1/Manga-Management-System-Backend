...
router.get(
  "/users/:userId",
  validate(vUsers.userIdParamSchema),
  ctrl.getUserById,
);
router.post("/users", validate(vUsers.createUserSchema), ctrl.createUser);
router.patch(
  "/users/:userId",
  validate(vUsers.updateUserSchema),
  ctrl.updateUser,
);
router.patch(
  "/users/:userId/status",
  validate(vUsers.updateUserStatusSchema),
  ctrl.updateUserStatus,
);
router.patch(
  "/users/:userId/role",
  validate(vUsers.updateUserRoleSchema),
  ctrl.updateUserRole,
);
router.delete(
  "/users/:userId",
...
router.get(
  "/series/:seriesId",
  validate(vSeries.seriesIdParamSchema),
  ctrl.getAdminSeriesById,
);
router.patch(
  "/series/:seriesId/status",
  validate(vSeries.updateSeriesStatusSchema),
  ctrl.updateAdminSeriesStatus,
);
router.delete(
  "/series/:seriesId",
  validate(vSeries.seriesIdParamSchema),
  ctrl.deleteAdminSeries,
);

// Chapters
router.get(
  "/chapters",
  validate(vChapters.listChaptersSchema),
  ctrl.listAdminChapters,
);
router.get(
  "/chapters/:chapterId",
  validate(vChapters.chapterIdParamSchema),
  ctrl.getAdminChapterById,
);
router.patch(
  "/chapters/:chapterId/status",
  validate(vChapters.updateChapterStatusSchema),
  ctrl.updateAdminChapterStatus,
);
router.delete(
  "/chapters/:chapterId",
  validate(vChapters.chapterIdParamSchema),
  ctrl.deleteAdminChapter,
);
...
router.get(
  "/pages/:pageId",
  validate(vPages.pageIdParamSchema),
  ctrl.getAdminPageById,
);
router.patch(
  "/pages/:pageId/status",
  validate(vPages.updatePageStatusSchema),
  ctrl.updateAdminPageStatus,
);
router.delete(
  "/pages/:pageId",
  validate(vPages.pageIdParamSchema),
  ctrl.deleteAdminPage,
);

// Tasks
router.get(
  "/page-tasks",
  validate(vPageTasks.listTasksSchema),
  ctrl.listAdminTasks,
);
router.get(
  "/page-tasks/:taskId",
  validate(vPageTasks.taskIdParamSchema),
  ctrl.getAdminTaskById,
);
router.patch(
  "/page-tasks/:taskId",
  validate(vPageTasks.updateTaskSchema),
  ctrl.updateAdminTask,
);
router.patch(
  "/page-tasks/:taskId/status",
  validate(vPageTasks.updateTaskStatusSchema),
  ctrl.updateAdminTaskStatus,
);
router.delete(
  "/page-tasks/:taskId",
  validate(vPageTasks.taskIdParamSchema),
  ctrl.deleteAdminTask,
);
...
router.patch(
  ...
  validate(vFeedbacks.updateFeedbackStatusSchema),
  ctrl.updateAdminFeedbackStatus,
);
router.delete(
  "/page-task-feedbacks/:feedbackId",
  validate(vFeedbacks.feedbackIdParamSchema),
...
router.get(
  ...
  validate(vAnnotations.annotationIdParamSchema),
  ctrl.getAdminAnnotationById,
);
router.patch(
  "/annotations/:annotationId/status",
  validate(vAnnotations.updateAnnotationStatusSchema),
  ctrl.updateAdminAnnotationStatus,
);
router.delete(
  "/annotations/:annotationId",
  validate(vAnnotations.annotationIdParamSchema),
  ctrl.deleteAdminAnnotation,
);
...
router.patch(
  "/review-sessions/:sessionId",
  validate(vReviewSessions.updateSessionSchema),
  ctrl.updateAdminSession,
);
router.patch(
  "/review-sessions/:sessionId/status",
  validate(vReviewSessions.updateSessionStatusSchema),
  ctrl.updateAdminSessionStatus,
);
router.delete(
  "/review-sessions/:sessionId",
  validate(vReviewSessions.sessionIdParamSchema),
...
router.get(
  "/votes/:voteId",
  validate(vVotes.voteIdParamSchema),
  ctrl.getAdminVoteById,
);
router.patch(
  "/votes/:voteId",
  validate(vVotes.updateVoteSchema),
  ctrl.updateAdminVote,
);
router.patch(
  "/votes/:voteId/status",
  validate(vVotes.updateVoteStatusSchema),
  ctrl.updateAdminVoteStatus,
);
router.delete(
  "/votes/:voteId",
  validate(vVotes.voteIdParamSchema),
  ctrl.deleteAdminVote,
);

// Ranking Periods
router.get("/ranking-periods", ctrl.listAdminPeriods);
router.get(
  "/ranking-periods/:periodId",
  validate(vRankingPeriods.periodIdParamSchema),
  ctrl.getAdminPeriodById,
);
router.post(
  "/ranking-periods",
  validate(vRankingPeriods.createPeriodSchema),
  ctrl.createAdminPeriod,
);
router.patch(
  "/ranking-periods/:periodId",
  validate(vRankingPeriods.updatePeriodSchema),
  ctrl.updateAdminPeriod,
);
router.patch(
  "/ranking-periods/:periodId/status",
  validate(vRankingPeriods.updatePeriodStatusSchema),
  ctrl.updateAdminPeriodStatus,
);
router.delete(
  "/ranking-periods/:periodId",
  validate(vRankingPeriods.periodIdParamSchema),
  ctrl.deleteAdminPeriod,
);
...
router.post(
  "/series-rankings",
  validate(vSeriesRankings.createSeriesRankingSchema),
  ctrl.createAdminSeriesRanking,
);
router.patch(
  "/series-rankings/:seriesRankingId",
  validate(vSeriesRankings.updateSeriesRankingSchema),
  ctrl.updateAdminSeriesRanking,
);
router.delete(
  "/series-rankings/:seriesRankingId",
  validate(vSeriesRankings.seriesRankingIdParamSchema),
  ctrl.deleteAdminSeriesRanking,
);
...
router.post(
  "/chapter-rankings",
  validate(vChapterRankings.createChapterRankingSchema),
  ctrl.createAdminChapterRanking,
);
router.patch(
  "/chapter-rankings/:chapterRankingId",
  validate(vChapterRankings.updateChapterRankingSchema),
  ctrl.updateAdminChapterRanking,
);
router.delete(
  "/chapter-rankings/:chapterRankingId",
  validate(vChapterRankings.chapterRankingIdParamSchema),
  ctrl.deleteAdminChapterRanking,
);
...
router.get(
  ...
  validate(vNotifications.notificationIdParamSchema),
  ctrl.getAdminNotificationById,
);
router.post(
  "/notifications",
  validate(vNotifications.createNotificationSchema),
  ctrl.createAdminNotification,
);
router.patch(
  "/notifications/:notificationId",
  validate(vNotifications.updateNotificationSchema),
  ctrl.updateAdminNotification,
);
router.delete(
  "/notifications/:notificationId",
  validate(vNotifications.notificationIdParamSchema),
  ctrl.deleteAdminNotification,
);
...
router.post(
  "/page-regions",
  validate(vPageRegions.createRegionSchema),
  ctrl.createAdminPageRegion,
);
router.patch(
  "/page-regions/:regionId",
  validate(vPageRegions.updateRegionSchema),
  ctrl.updateAdminPageRegion,
);
router.delete(
  "/page-regions/:regionId",
  validate(vPageRegions.regionIdParamSchema),
  ctrl.deleteAdminPageRegion,
);
