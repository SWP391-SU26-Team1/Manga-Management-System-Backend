...
router.use('/series/:seriesId/chapters/:chapterId/pages/:pageId/regions', regionsRoutes);

// Nested: /series/:seriesId/chapters/:chapterId/pages/:pageId/tasks
router.use('/series/:seriesId/chapters/:chapterId/pages/:pageId/tasks', pageTasksRoutes);

// Nested: /series/:seriesId/chapters/:chapterId/pages/:pageId/annotations
router.use('/series/:seriesId/chapters/:chapterId/pages/:pageId/annotations', annotationsRoutes);
