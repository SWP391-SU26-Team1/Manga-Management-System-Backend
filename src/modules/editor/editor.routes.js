...
router.get('/dashboard/assistants/:assistantId/performance', ctrl.assistantPerformance);

// Review Tasks
router.get('/review/page-tasks/pending', (req, res, next) => { req.query.status = 'submitted'; ctrl.listReviewTasks(req, res, next); });
...
router.patch('/page-tasks/:taskId/start-review', ctrl.taskWorkflow('start-review'));
router.patch('/page-tasks/:taskId/approve', ctrl.taskWorkflow('approve'));
router.patch('/page-tasks/:taskId/request-revision', ctrl.taskWorkflow('request-revision'));
...
router.patch('/page-tasks/:taskId/override-status', ctrl.taskWorkflow('override-status'));
...
// Review Manuscripts
router.get('/review/manuscripts/pending', (req, res, next) => { req.query.status = 'submitted'; ctrl.listReviewManuscripts(req, res, next); });
...
router.get('/review/manuscripts/:manuscriptId/detail', ctrl.getReviewManuscriptDetail);
router.patch('/manuscripts/:manuscriptId/start-review', ctrl.manuscriptWorkflow('start-review'));
router.patch('/manuscripts/:manuscriptId/approve', ctrl.manuscriptWorkflow('approve'));
router.patch('/manuscripts/:manuscriptId/request-revision', ctrl.manuscriptWorkflow('request-revision'));
router.patch('/manuscripts/:manuscriptId/reject', ctrl.manuscriptWorkflow('reject'));
router.patch('/manuscripts/:manuscriptId/publish', ctrl.manuscriptWorkflow('publish'));
router.patch('/manuscripts/:manuscriptId/archive', ctrl.manuscriptWorkflow('archive'));
router.patch('/manuscripts/:manuscriptId/override-status', ctrl.manuscriptWorkflow('override-status'));
...
router.patch('/page-task-feedbacks/:feedbackId/status', ctrl.updateFeedbackStatus);
...
router.patch('/review-sessions/:sessionId/start', ctrl.reviewSessionWorkflow('start'));
router.patch('/review-sessions/:sessionId/pause', ctrl.reviewSessionWorkflow('pause'));
router.patch('/review-sessions/:sessionId/complete', ctrl.reviewSessionWorkflow('complete'));
router.patch('/review-sessions/:sessionId/finish', ctrl.reviewSessionWorkflow('finish'));
router.patch('/review-sessions/:sessionId/cancel', ctrl.reviewSessionWorkflow('cancel'));

// Proposals (as review_session)
router.post('/proposals/series', ctrl.createProposal('series'));
router.post('/proposals/chapters', ctrl.createProposal('chapter'));
router.post('/proposals/cancel-series', ctrl.createProposal('cancel-series'));
router.post('/proposals/schedule-change', ctrl.createProposal('schedule-change'));
