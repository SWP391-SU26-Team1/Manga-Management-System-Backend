...
router.patch('/:userId/status', authenticateToken, requireRole(['admin']), validate(v.updateUserStatusSchema), controller.updateUserStatus);
router.delete('/:userId', authenticateToken, requireRole(['admin']), validate(v.userIdParamSchema), controller.deleteUser);
